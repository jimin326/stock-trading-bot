...
EMA_TOUCH_PCT      = 0.003  # EMA 눌림목 인정 범위 (0.3%)
PULLBACK_LOWER_PCT = 0.003  # 눌림목 하한선: EMA 기준 -0.3% 이내까지만 인정
VWAP_TOUCH_PCT     = 0.003  # VWAP 리테스트 인정 범위 (0.3%)
PREMARKET_TOUCH_PCT = 0.005 # VWAP ↔ 프리마켓 고/저점 일치 인정 범위 (0.5%)

HARD_STOP_PCT      = 0.01   # 하드 손절 -1%
FRACTIONAL_SHARES  = True   # True=소수점 거래, False=정수 거래
COOLDOWN_BARS    = 2      # 청산 후 재진입 금지 캔들 수 (2캔들 = 10분)
STRICT_EXIT      = False  # True=종가 EMA 이탈 즉시 청산, False=몸통 전체 이탈
